 ...
 */
declare function Logger(optionsOrStream?: Logger.LoggerOptions | Logger.DestinationStream): Logger.Logger;
 ...
 * @returns a new logger instance.
 */
declare function Logger(options: Logger.LoggerOptions, stream: Logger.DestinationStream): Logger.Logger;
